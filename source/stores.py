...
class scraper:
    def scrape_store(url):
        ...
        details["Store Name"] = soup.find("h1", class_="Home_name__J6U_a").text.strip()
        ...
        details["Phone Number"] = tel_links[1]["href"].split(":")[1]
        details["Google Map Link"] = soup.find(
        ...
        details["Nearby Stores"] = nearby_store_details
